...
namespace ZptSharp.Dom
{
    ...
    public class HapDocumentProviderTests
    {
        [Test,AutoMoqData]
        ...
        {
            var sut = new HapDocumentProvider();
            Assert.That(() => sut.CanReadWriteForFilename(filename), Is.True);
        }

        [Test, AutoMoqData]
        public void CanReadWriteForFilename_returns_false_for_null_filename(HapDocumentProvider sut)
        {
            Assert.That(() => sut.CanReadWriteForFilename(null), Is.False);
        }

        [Test, AutoMoqData]
        public void CanReadWriteForFilename_returns_false_for_empty_filename(HapDocumentProvider sut)
        {
