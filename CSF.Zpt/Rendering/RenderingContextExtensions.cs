...
namespace CSF.Zpt.Rendering
{
  ...
  public static class RenderingContextExtensions
  {
    ...
    public static ZptAttribute GetMetalAttribute(this RenderingContext context, string attributeName)
    {
      if(context == null)
      {
    ...
    /// <param name="context">The rendering context from which to get attributes.</param>
    /// <param name="attributeName">The attribute name.</param>
    public static ZptAttribute GetTalAttribute(this RenderingContext context, string attributeName)
    {
      if(context == null)
      {
        throw new ArgumentNullException(nameof(context));
