...
namespace Test.CraigFowler.Web.ZPT.Tal
{
  ...
  public class TestRepeatVariable
  {
    ...
    public void TestGenerateLetterReference()
    {
      ...
      Assert.AreEqual("sg",  test.GenerateLetterReference(500),  "Letter reference for 500");
      Assert.AreEqual("dkk", test.GenerateLetterReference(3000), "Letter reference for 3000");
    }
  }
}
