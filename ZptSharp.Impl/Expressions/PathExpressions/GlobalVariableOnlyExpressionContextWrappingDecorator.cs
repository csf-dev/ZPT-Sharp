...
namespace ZptSharp.Expressions.PathExpressions
{
    ...
    /// only global variables to resolve values from the expression context.
    /// Similar to <seealso cref="ExpressionContextWrappingDecorator"/>.
    /// </summary>
    public class GlobalVariableOnlyExpressionContextWrappingDecorator : IGetsValueFromObject
    {
        ...
        /// service with an instance of <see cref="GlobalVariablesOnlyTalesValueForExpressionContextAdapter"/> wrapping
        ...
        public Task<GetValueResult> TryGetValueAsync(string name, object @object, CancellationToken cancellationToken = default)
        {
            ...
            if (obj is ExpressionContext expressionContext)
                obj = new GlobalVariablesOnlyTalesValueForExpressionContextAdapter(expressionContext);
        ...
        /// <see cref="GlobalVariableOnlyExpressionContextWrappingDecorator"/> class.
        /// </summary>
        /// <param name="wrapped">Wrapped.</param>
        public GlobalVariableOnlyExpressionContextWrappingDecorator(IGetsValueFromObject wrapped)
        {
