...
namespace ZptSharp.Expressions.PathExpressions
{
    ...
    /// only defined (global or local) variables to resolve values from the expression context.
    ...
    public class DefinedVariablesOnlyExpressionContextWrappingDecorator : IGetsValueFromObject
    {
        ...
        /// service with an instance of <see cref="DefinedVariablesOnlyTalesValueForExpressionContextAdapter"/> wrapping
        ...
        public Task<GetValueResult> TryGetValueAsync(string name, object @object, CancellationToken cancellationToken = default)
        {
            ...
            if (obj is ExpressionContext expressionContext)
                obj = new DefinedVariablesOnlyTalesValueForExpressionContextAdapter(expressionContext);
        ...
        /// <see cref="DefinedVariablesOnlyExpressionContextWrappingDecorator"/> class.
        /// </summary>
