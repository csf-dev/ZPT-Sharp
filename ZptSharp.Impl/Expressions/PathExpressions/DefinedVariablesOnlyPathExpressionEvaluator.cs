...
{
    /// <summary>
    /// An implementation of <see cref="IEvaluatesExpression"/> which evaluates TALES 'var' expressions.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public class DefinedVariablesOnlyPathExpressionEvaluator : IEvaluatesExpression
    {
        ...
        {
            var request = new PathExpressionEvaluationRequest(expression, context, RootScopeLimitation.DefinedVariablesOnly);
            return requestEvaluator.EvaluateAsync(request, cancellationToken);
        }

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="DefinedVariablesOnlyPathExpressionEvaluator"/> class.
        /// </summary>
