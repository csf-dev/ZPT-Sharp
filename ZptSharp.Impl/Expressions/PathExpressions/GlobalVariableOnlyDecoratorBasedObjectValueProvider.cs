...
namespace ZptSharp.Expressions.PathExpressions
{
    ...
    /// an expression context by use of global variables, and not any other kind of variable.
    /// </summary>
    public class GlobalVariableOnlyDecoratorBasedObjectValueProvider : DecoratorBasedObjectValueProvider, IGetsValueFromObjectWithGlobalVariablesOnly
    {
        /// <summary>
        ...
        protected override IGetsValueFromObject GetContextWrappingDecorator(IGetsValueFromObject service)
            => new GlobalVariableOnlyExpressionContextWrappingDecorator(service);

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="GlobalVariableOnlyDecoratorBasedObjectValueProvider"/> class.
        /// </summary>
        ...
        public GlobalVariableOnlyDecoratorBasedObjectValueProvider(RenderingConfig config,
