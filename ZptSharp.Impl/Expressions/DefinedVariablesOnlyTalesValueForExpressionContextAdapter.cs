...
{
    /// <summary>
    /// Implementation of <see cref="IGetsNamedTalesValue"/> which exposes defined (local &amp; global)
    /// variables from the wrapped <see cref="ExpressionContext"/>.
    /// </summary>
    public class DefinedVariablesOnlyTalesValueForExpressionContextAdapter : IGetsNamedTalesValue
    {
        ...
        /// <see cref="DefinedVariablesOnlyTalesValueForExpressionContextAdapter"/> class.
        /// </summary>
