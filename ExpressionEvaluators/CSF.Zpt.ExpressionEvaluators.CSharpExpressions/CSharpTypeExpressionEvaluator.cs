...
{
  /// <summary>
  /// Evaluator implementation for <c>cstype</c> expressions.
  /// </summary>
  public class CSharpTypeExpressionEvaluator : ExpressionEvaluatorBase
  {
    #region constants
                                              ...
                                              ITalesModel model)
    {
      ...
      return new ExpressionResult(new Spec.VariableTypeDefinition(valueMatch.Groups[1].Value,
